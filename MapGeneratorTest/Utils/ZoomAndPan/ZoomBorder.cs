...
public partial class ZoomBorder : Border
{
    ...
    /// <summary>
    /// Raises <see cref="ZoomBorder.ZoomChanged"/> event.
    /// </summary>
    ...
    private void InvalidateProperties()
    {
        ...
        RaisePropertyChanged(ZoomBorder.ZoomXProperty,   oldZoomX,   _zoomX);
        RaisePropertyChanged(ZoomBorder.ZoomYProperty,   oldZoomY,   _zoomY);
        RaisePropertyChanged(ZoomBorder.OffsetXProperty, oldOffsetX, _offsetX);
        RaisePropertyChanged(ZoomBorder.OffsetYProperty, oldOffsetY, _offsetY);
    }
