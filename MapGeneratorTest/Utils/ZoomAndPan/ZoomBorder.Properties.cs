...
namespace AFRDL.Utils.ZoomAndPan;
...
public partial class ZoomBorder
{
    ...
    public static StyledProperty<ButtonName> PanButtonProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, ButtonName>(nameof(PanButton), ButtonName.Middle, false, BindingMode.TwoWay);

    /// <summary>
    /// Identifies the <seealso cref="ZoomSpeed"/> avalonia property.
    /// </summary>
    public static StyledProperty<double> ZoomSpeedProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, double>(nameof(ZoomSpeed), 1.2, false, BindingMode.TwoWay);

    /// <summary>
    /// Identifies the <seealso cref="PowerFactor"/> avalonia property.
    /// </summary>
    public static StyledProperty<double> PowerFactorProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, double>(nameof(PowerFactor), 1, false, BindingMode.TwoWay);
    ...
    public static StyledProperty<double> TransitionThresholdProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, double>(nameof(TransitionThreshold), 0.5, false, BindingMode.TwoWay);

    /// <summary>
    /// Identifies the <seealso cref="Stretch"/> avalonia property.
    /// </summary>
    public static StyledProperty<StretchMode> StretchProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, StretchMode>(nameof(Stretch), StretchMode.Uniform, false, BindingMode.TwoWay);

    /// <summary>
    /// Identifies the <seealso cref="ZoomX"/> avalonia property.
    /// </summary>
    public static readonly DirectProperty<AFRDL.Utils.ZoomAndPan.ZoomBorder, double> ZoomXProperty =
        AvaloniaProperty.RegisterDirect<AFRDL.Utils.ZoomAndPan.ZoomBorder, double>(nameof(ZoomX), o => o.ZoomX, null, 1.0);

    /// <summary>
    /// Identifies the <seealso cref="ZoomY"/> avalonia property.
    /// </summary>
    public static readonly DirectProperty<AFRDL.Utils.ZoomAndPan.ZoomBorder, double> ZoomYProperty =
        AvaloniaProperty.RegisterDirect<AFRDL.Utils.ZoomAndPan.ZoomBorder, double>(nameof(ZoomY), o => o.ZoomY, null, 1.0);

    /// <summary>
    /// Identifies the <seealso cref="OffsetX"/> avalonia property.
    /// </summary>
    public static readonly DirectProperty<AFRDL.Utils.ZoomAndPan.ZoomBorder, double> OffsetXProperty =
        AvaloniaProperty.RegisterDirect<AFRDL.Utils.ZoomAndPan.ZoomBorder, double>(nameof(OffsetX), o => o.OffsetX, null, 0.0);

    /// <summary>
    /// Identifies the <seealso cref="OffsetY"/> avalonia property.
    /// </summary>
    public static readonly DirectProperty<AFRDL.Utils.ZoomAndPan.ZoomBorder, double> OffsetYProperty =
        AvaloniaProperty.RegisterDirect<AFRDL.Utils.ZoomAndPan.ZoomBorder, double>(nameof(OffsetY), o => o.OffsetY, null, 0.0);

    /// <summary>
    /// Identifies the <seealso cref="EnableConstrains"/> avalonia property.
    /// </summary>
    public static StyledProperty<bool> EnableConstrainsProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, bool>(nameof(EnableConstrains), true, false, BindingMode.TwoWay);

    /// <summary>
    /// Identifies the <seealso cref="MinZoomX"/> avalonia property.
    /// </summary>
    public static StyledProperty<double> MinZoomXProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, double>(nameof(MinZoomX), double.NegativeInfinity, false, BindingMode.TwoWay);

    /// <summary>
    /// Identifies the <seealso cref="MaxZoomX"/> avalonia property.
    /// </summary>
    public static StyledProperty<double> MaxZoomXProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, double>(nameof(MaxZoomX), double.PositiveInfinity, false, BindingMode.TwoWay);

    /// <summary>
    /// Identifies the <seealso cref="MinZoomY"/> avalonia property.
    /// </summary>
    public static StyledProperty<double> MinZoomYProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, double>(nameof(MinZoomY), double.NegativeInfinity, false, BindingMode.TwoWay);

    /// <summary>
    /// Identifies the <seealso cref="MaxZoomY"/> avalonia property.
    /// </summary>
    public static StyledProperty<double> MaxZoomYProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, double>(nameof(MaxZoomY), double.PositiveInfinity, false, BindingMode.TwoWay);

    /// <summary>
    /// Identifies the <seealso cref="MinOffsetX"/> avalonia property.
    /// </summary>
    public static StyledProperty<double> MinOffsetXProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, double>(nameof(MinOffsetX), double.NegativeInfinity, false, BindingMode.TwoWay);

    /// <summary>
    /// Identifies the <seealso cref="MaxOffsetX"/> avalonia property.
    /// </summary>
    public static StyledProperty<double> MaxOffsetXProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, double>(nameof(MaxOffsetX), double.PositiveInfinity, false, BindingMode.TwoWay);

    /// <summary>
    /// Identifies the <seealso cref="MinOffsetY"/> avalonia property.
    /// </summary>
    public static StyledProperty<double> MinOffsetYProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, double>(nameof(MinOffsetY), double.NegativeInfinity, false, BindingMode.TwoWay);

    /// <summary>
    /// Identifies the <seealso cref="MaxOffsetY"/> avalonia property.
    /// </summary>
    public static StyledProperty<double> MaxOffsetYProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, double>(nameof(MaxOffsetY), double.PositiveInfinity, false, BindingMode.TwoWay);

    /// <summary>
    /// Identifies the <seealso cref="EnablePan"/> avalonia property.
    /// </summary>
    public static StyledProperty<bool> EnablePanProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, bool>(nameof(EnablePan), true, false, BindingMode.TwoWay);

    /// <summary>
    /// Identifies the <seealso cref="EnableZoom"/> avalonia property.
    /// </summary>
    public static StyledProperty<bool> EnableZoomProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, bool>(nameof(EnableZoom), true, false, BindingMode.TwoWay);
    ...
    public static StyledProperty<bool> EnableGestureZoomProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, bool>(nameof(EnableGestureZoom), true, false, BindingMode.TwoWay);
    ...
    public static StyledProperty<bool> EnableGestureRotationProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, bool>(nameof(EnableGestureRotation), true, false, BindingMode.TwoWay);
    ...
    public static StyledProperty<bool> EnableGestureTranslationProperty =
        AvaloniaProperty.Register<AFRDL.Utils.ZoomAndPan.ZoomBorder, bool>(nameof(EnableGestureTranslation), true, false, BindingMode.TwoWay);

    static ZoomBorder()
    {
        AffectsArrange<AFRDL.Utils.ZoomAndPan.ZoomBorder>(
                                                          ZoomSpeedProperty,
                                                          StretchProperty,
